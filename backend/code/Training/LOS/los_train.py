...
# Sensible defaults for your environment
DEFAULT_DATA_ROOT = "/userhome/cs/u3597462/Autoscout/Data/LOS/Training1"
DEFAULT_OUT_DIR = "/userhome/cs/u3597462/Autoscout/runs"
DEFAULT_RUN_NAME = "LOS_test"
DEFAULT_MODEL = "yolov8n.pt"  # detection model (boxes), not segmentation


def find_data_yaml(data_arg: str) -> str:
	"""
	Resolve a dataset YAML path for YOLO detection.
...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Train YOLOv8 object detection on LOS dataset.")
	...
	parser.add_argument("--model", type=str, default=DEFAULT_MODEL, help="Starting model weights, e.g. yolov8n.pt or a custom .pt.")
	...
	# Common photographic augmentations (tunable)
...
def main() -> None:
	...
	if args.resume:
		...
		if last_ckpt:
			...
			print("[warn] --resume set but no checkpoint found. Starting from base model instead.")
	elif args.weights:
